...
let hideAxises = function(chart: IChart) {
    chart.axis = {
        x: {
            show: false
        },
...
let hideXAxis = function(chart: IChart) {
    chart.axis = {
        x: {
            show: false
        }
...
let hideYAxis = function(chart: IChart) {
    chart.axis = {
        y: {
            show: false
        }
...
let setPaddingToZero = function(chart: IChart) {
    chart.bar = { padding: 0 };
    return chart;
};
...
describe ("Bar Chart", () => {
    ...
    it("should be possible to create a bar chart with minimal setup", () => {
        ...
        const expectedOutput: string = "<svg width=\"100%\" perserveAspectRatio=\"xMidYMid\" viewbox=\"0 0 3840 1080\">" +
        ...
        "<text x=175 y=880 fill=\"black\" alignment-baseline=\"middle\" text-anchor=\"end\" style=\"font-family: sans-serif; font-size: 48px\">0.0</text>" +
        "<line x1=175 y1=766 x2=200 y2=766 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=175 y=766 fill=\"black\" alignment-baseline=\"middle\" text-anchor=\"end\" style=\"font-family: sans-serif; font-size: 48px\">0.5</text>" +
        "<line x1=175 y1=653 x2=200 y2=653 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=175 y=653 fill=\"black\" alignment-baseline=\"middle\" text-anchor=\"end\" style=\"font-family: sans-serif; font-size: 48px\">1.0</text>" +
        "<line x1=175 y1=540 x2=200 y2=540 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=175 y=540 fill=\"black\" alignment-baseline=\"middle\" text-anchor=\"end\" style=\"font-family: sans-serif; font-size: 48px\">1.5</text>" +
        "<line x1=175 y1=426 x2=200 y2=426 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=175 y=426 fill=\"black\" alignment-baseline=\"middle\" text-anchor=\"end\" style=\"font-family: sans-serif; font-size: 48px\">2.0</text>" +
        "<line x1=175 y1=313 x2=200 y2=313 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=175 y=313 fill=\"black\" alignment-baseline=\"middle\" text-anchor=\"end\" style=\"font-family: sans-serif; font-size: 48px\">2.5</text>" +
        "<line x1=175 y1=200 x2=200 y2=200 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=175 y=200 fill=\"black\" alignment-baseline=\"middle\" text-anchor=\"end\" style=\"font-family: sans-serif; font-size: 48px\">3.0</text>" +
        ...
        "<text x=773 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">1</text>" +
        "<line x1=1919 y1=880 x2=1919 y2=905 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=1919 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">2</text>" +
        "<line x1=3065 y1=880 x2=3065 y2=905 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=3065 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">3</text>" +
        "</svg>";
    ...
    it("should be possible to render graph with specific values on x-axis", () => {
        ...
        const expectedOutput: string = "<svg width=\"100%\" perserveAspectRatio=\"xMidYMid\" viewbox=\"0 0 3840 1080\">" +
                                       ...
                                       "<line x1=175 y1=880 x2=3640 y2=880 stroke=\"black\" stroke-width=\"5\"></line>" +
                                       "<line x1=773 y1=880 x2=773 y2=905 stroke=\"black\" stroke-width=\"5\"></line>" +
                                       "<text x=773 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">11</text>" +
                                       "<line x1=1919 y1=880 x2=1919 y2=905 stroke=\"black\" stroke-width=\"5\"></line>" +
                                       "<text x=1919 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">12</text>" +
                                       "<line x1=3065 y1=880 x2=3065 y2=905 stroke=\"black\" stroke-width=\"5\"></line>" +
                                       "<text x=3065 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">13</text>" +
                                       "</svg>";
    ...
    it("should be possible to render a graph with all x values on x-axis even if there is a hole in the given x series", () => {
        let input = deepcopy(barChartData);
        ...
        "<text x=630 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">11</text>" +
        "<line x1=1490 y1=880 x2=1490 y2=905 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=1490 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">12</text>" +
        "<line x1=2350 y1=880 x2=2350 y2=905 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=2350 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">13</text>" +
        "<line x1=3210 y1=880 x2=3210 y2=905 stroke=\"black\" stroke-width=\"5\"></line>" +
        "<text x=3210 y=905 fill=\"black\" alignment-baseline=\"hanging\" text-anchor=\"middle\" style=\"font-family: sans-serif; font-size: 48px\">14</text>" +
        "</svg>";
